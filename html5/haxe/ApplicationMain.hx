...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("haxeflixel-game", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("haxeflixel-game", null, 640, 360);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "haxeflixel-game";
		app.meta["name"] = "haxeflixel-game";
